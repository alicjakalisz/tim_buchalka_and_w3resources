...
public class Minivan extends AbstractVan{
    ...
    public Minivan(boolean diesel2, Integer wheels2, String brand2, Float trunkSize2, Integer passengers2, Integer beds2){
